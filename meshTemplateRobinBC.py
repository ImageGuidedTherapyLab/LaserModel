...
cubit.cmd('block 2 volume 8 10 11 13 15 16 18 20 26 28 29 30 32 33 34 36 42 44 45 46 48 49 50 52 58 60 61 62 64 65 66 68')
cubit.cmd('block 2 name "catheder"  ')
cubit.cmd('block 3 volume 21 37 53 69')
cubit.cmd('block 3 name "laserTip"  ')
cubit.cmd('volume all scale 0.001')
cubit.cmd('export mesh "meshTemplateRobinBC%d.e" overwrite' % resolutionID)
cubit.cmd('export abaqus "meshTemplateRobinBC%d.inp" overwrite' % resolutionID)
