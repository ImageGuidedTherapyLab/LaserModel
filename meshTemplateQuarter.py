...
# volume
cubit.cmd('block 1 volume 1 4 5 6 9 14 19 ')
cubit.cmd('block 1 name "brain"  ')
cubit.cmd('block 2 volume 13 15 16 20')
cubit.cmd('block 2 name "inflow"  ')
cubit.cmd('block 3 volume 8 10 11 ')
cubit.cmd('block 3 name "outflow"  ')
cubit.cmd('block 4 volume 18 ')
cubit.cmd('block 4 name "applicator"  ')
cubit.cmd('block 5 volume 21')
cubit.cmd('block 5 name "laserTip"  ')
cubit.cmd('volume all scale 0.001')
cubit.cmd('export mesh "meshTemplateQuarter%d.e" overwrite' % resolutionID)
#cubit.cmd('   comment "fine size is" {_fineSize} "and coarse size is" {_coarseSize} ')
#cubit.cmd('   # update looping variable')
